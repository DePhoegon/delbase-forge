...
public class shiftingDyes {
    ...
    private static blockDye blockDyeAid(DyeColor color, int stack_cnt, String ctrl) { return blockDyeAid(color, stack_cnt, "tooltip.delbase.info.shift.more","tooltip.delbase.color.shifter", ctrl); }
    private static blockDye blockDyeAid(DyeColor color, int stack_cnt, String norm, String shift, String ctrl) { return new blockDye(color, new Item.Properties().stacksTo(stack_cnt), norm, shift, ctrl); }
