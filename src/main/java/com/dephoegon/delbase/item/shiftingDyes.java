...
public class shiftingDyes {
    ...
    private static blockDye blockDyeAid(DyeColor color, int stack_size, String Norm, String Shift, String Ctrl) { return new blockDye(color, new Item.Properties().stacksTo(stack_size), Norm, Shift, Ctrl); }
