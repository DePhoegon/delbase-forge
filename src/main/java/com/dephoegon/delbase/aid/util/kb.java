...
import static com.dephoegon.delbase.aid.event.KeyBindManager.R_Cntrl;
import static com.dephoegon.delbase.aid.event.KeyBindManager.R_Shift;
...
public class kb {
    ...
    private static boolean RCtrl() { return isKB_KeyBindDown(R_Cntrl); }
