...
public class cutSandStoneStair extends stairBlock{
    public cutSandStoneStair(String normToolTip, String shiftToolTip, String ctrlToolTip) {
        super(CUT_SANDSTONE::defaultBlockState, BlockBehaviour.Properties.copy(CHISELED_SANDSTONE).sound(SoundType.STONE), normToolTip, shiftToolTip, ctrlToolTip,false, 0 ,0, null);
    }
}
