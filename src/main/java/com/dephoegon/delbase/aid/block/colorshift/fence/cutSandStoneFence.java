...
public class cutSandStoneFence extends fenceBlock {
    public cutSandStoneFence(Properties properties, String normToolTip, String shiftToolTip, String ctrlToolTip) {
        super(properties, normToolTip, shiftToolTip, ctrlToolTip, false, 0, 0, null);
    }
    public cutSandStoneFence(Properties properties) {
