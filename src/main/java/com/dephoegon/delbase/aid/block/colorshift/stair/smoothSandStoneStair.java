...
public class smoothSandStoneStair extends stairBlock {
    public smoothSandStoneStair(String normToolTip, String shiftToolTip, String ctrlToolTip) {
        super(SMOOTH_SANDSTONE::defaultBlockState, BlockBehaviour.Properties.copy(SMOOTH_SANDSTONE).sound(SoundType.STONE), normToolTip, shiftToolTip, ctrlToolTip,false, 0 ,0, null);
    }
}
