...
public class cutSandStoneFenceGate extends fenceGateBlock {
    public cutSandStoneFenceGate(Properties properties, String normToolTip, String shiftToolTip, String ctrlToolTip) {
        super(properties, normToolTip, shiftToolTip, ctrlToolTip, false, 0 ,0, null);
    }
    public cutSandStoneFenceGate(Properties properties) {
