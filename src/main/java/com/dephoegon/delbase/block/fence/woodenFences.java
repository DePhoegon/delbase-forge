...
public class woodenFences {
    ...
    public static final RegistryObject<FenceBlock> MANGROVE_WOOD_FENCE = register("mangrove_wood_fence",
            () -> new woodFence(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_RED).strength(2.0F, 3.0F).sound(SoundType.WOOD), true, STRIPPED_MANGROVE_WOOD_FENCE.get().defaultBlockState()), 1000);
    public static final RegistryObject<FenceGateBlock> MANGROVE_WOOD_FENCE_GATE = register("mangrove_wood_fence_gate",
            () -> new woodFenceGate(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_RED).strength(2.0F, 3.0F).sound(SoundType.WOOD), true, STRIPPED_MANGROVE_WOOD_FENCE_GATE.get().defaultBlockState()), 1000);
    public static final RegistryObject<FenceBlock> MANGROVE_LOG_FENCE = register("mangrove_log_fence",
            () -> new woodFence(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_RED).strength(2.0F, 3.0F).sound(SoundType.WOOD), true, STRIPPED_MANGROVE_LOG_FENCE.get().defaultBlockState()), 1000);
    public static final RegistryObject<FenceGateBlock> MANGROVE_LOG_FENCE_GATE = register("mangrove_log_fence_gate",
            () -> new woodFenceGate(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_RED).strength(2.0F, 3.0F).sound(SoundType.WOOD), true, STRIPPED_MANGROVE_LOG_FENCE_GATE.get().defaultBlockState()), 1000);
