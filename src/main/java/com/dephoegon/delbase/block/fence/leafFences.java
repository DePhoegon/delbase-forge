...
public class leafFences {
    ...
    public static final RegistryObject<FenceBlock> MANGROVE_LEAF_FENCE = register("mangrove_leaf_fence",
            () -> new fenceBlock(BlockBehaviour.Properties.copy(MANGROVE_LEAVES).sound(SoundType.GRASS).mapColor(MapColor.PLANT).noOcclusion().isSuffocating(genBlock::never).isViewBlocking(genBlock::never).noOcclusion(),
                    "","","", true, null));
    public static final RegistryObject<FenceGateBlock> MANGROVE_LEAF_FENCE_GATE = register("mangrove_leaf_fence_gate",
            () -> new fenceGateBlock(BlockBehaviour.Properties.copy(MANGROVE_LEAVES).mapColor(MapColor.PLANT).sound(SoundType.GRASS).noOcclusion().isSuffocating(genBlock::never).isViewBlocking(genBlock::never).noOcclusion(),
                    "","","", true, null));
    public static final RegistryObject<FenceBlock> AZALEA_LEAF_FENCE = register("azalea_leaf_fence",
            () -> new fenceBlock(BlockBehaviour.Properties.copy(AZALEA_LEAVES).sound(SoundType.AZALEA_LEAVES).mapColor(MapColor.PLANT).noOcclusion().isSuffocating(genBlock::never).isViewBlocking(genBlock::never).noOcclusion(),
                    "","","", true, null));
    public static final RegistryObject<FenceGateBlock> AZALEA_LEAF_FENCE_GATE = register("azalea_leaf_fence_gate",
            () -> new fenceGateBlock(BlockBehaviour.Properties.copy(AZALEA_LEAVES).sound(SoundType.AZALEA_LEAVES).mapColor(MapColor.PLANT).noOcclusion().isSuffocating(genBlock::never).isViewBlocking(genBlock::never).noOcclusion(),
                    "","","", true, null));
    public static final RegistryObject<FenceBlock> FLOWERING_AZALEA_LEAF_FENCE = register("flowering_azalea_leaf_fence",
            () -> new fenceBlock(BlockBehaviour.Properties.copy(FLOWERING_AZALEA_LEAVES).sound(SoundType.FLOWERING_AZALEA).mapColor(MapColor.PLANT).noOcclusion().isSuffocating(genBlock::never).isViewBlocking(genBlock::never).noOcclusion(),
                    "","","", true, null));
    public static final RegistryObject<FenceGateBlock> FLOWERING_AZALEA_LEAF_FENCE_GATE = register("flowering_azalea_leaf_fence_gate",
            () -> new fenceGateBlock(BlockBehaviour.Properties.copy(FLOWERING_AZALEA_LEAVES).sound(SoundType.FLOWERING_AZALEA).mapColor(MapColor.PLANT).noOcclusion().isSuffocating(genBlock::never).isViewBlocking(genBlock::never).noOcclusion(),
                    "","","", true, null));
    public static final RegistryObject<FenceBlock> CHERRY_LEAF_FENCE = register("cherry_leaf_fence",
            () -> new fenceBlock(BlockBehaviour.Properties.copy(CHERRY_LEAVES).sound(SoundType.CHERRY_LEAVES).noOcclusion().isSuffocating(genBlock::never).isViewBlocking(genBlock::never).noOcclusion(),
                    "","","", true, null));
    public static final RegistryObject<FenceGateBlock> CHERRY_LEAF_FENCE_GATE = register("cherry_leaf_fence_gate",
            () -> new fenceGateBlock(BlockBehaviour.Properties.copy(CHERRY_LEAVES).sound(SoundType.CHERRY_LEAVES).noOcclusion().isSuffocating(genBlock::never).isViewBlocking(genBlock::never).noOcclusion(),
                    "","","", true, null));
