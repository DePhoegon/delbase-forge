...
public class slabLeaves {
    ...
    public static final RegistryObject<SlabBlock> MANGROVE_LEAF_SLAB = register("mangrove_leaf_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.copy(MANGROVE_LEAVES).sound(SoundType.GRASS).mapColor(MapColor.PLANT).noOcclusion().isSuffocating(genBlock::never).isViewBlocking(genBlock::never).noOcclusion()
                    ,"","","", true, null));
    public static final RegistryObject<SlabBlock> CHERRY_LEAF_SLAB = register("cherry_leaf_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.copy(CHERRY_LEAVES).sound(SoundType.CHERRY_LEAVES).noOcclusion().isSuffocating(genBlock::never).isViewBlocking(genBlock::never).noOcclusion()
                    ,"","","", true, null));
    public static final RegistryObject<SlabBlock> AZALEA_LEAF_SLAB = register("azalea_leaf_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.copy(AZALEA_LEAVES).sound(SoundType.AZALEA_LEAVES).noOcclusion().mapColor(MapColor.PLANT).isSuffocating(genBlock::never).isViewBlocking(genBlock::never).noOcclusion()
                    ,"","","", true, null));
    public static final RegistryObject<SlabBlock> FLOWERING_AZALEA_LEAF_SLAB = register("flowering_azalea_leaf_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.copy(FLOWERING_AZALEA_LEAVES).mapColor(MapColor.PLANT).sound(SoundType.FLOWERING_AZALEA).noOcclusion().isSuffocating(genBlock::never).isViewBlocking(genBlock::never).noOcclusion()
                    ,"","","", true, null));
