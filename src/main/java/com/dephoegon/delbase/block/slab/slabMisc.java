...
public class slabMisc {
    ...
    public static final RegistryObject<SlabBlock> COAL_BLOCK_SLAB = register("coal_block_slab",
            ()-> new woodSlab(COAL_BLOCK, SoundType.WOOD, true, null),16000);
    ...
    public static final RegistryObject<SlabBlock> PACKED_MUD_SLAB = register("packed_mud_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.copy(PACKED_MUD).sound(SoundType.PACKED_MUD), false, 0, 0, null));
    public static final RegistryObject<SlabBlock> SCULK_SLAB = register("sculk_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.copy(SCULK).sound(SoundType.SCULK), false, 0, 0, null));
    public static final RegistryObject<SlabBlock> MUD_SLAB = register("mud_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.copy(MUD).sound(SoundType.MUD), false, 0, 0, null));
    ...
    public static final RegistryObject<SlabBlock> MANGROVE_ROOT_SLAB = register("mangrove_root_slab",
            ()-> new leafSlab(MANGROVE_ROOTS, SoundType.MANGROVE_ROOTS, true, null));
    public static final RegistryObject<SlabBlock> OCHRE_FROGLIGHT_SLAB = register("ochre_froglight_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.copy(OCHRE_FROGLIGHT).sound(SoundType.FROGLIGHT).lightLevel((blockstate) -> 15), false, 0, 0, null));
    public static final RegistryObject<SlabBlock> VERDANT_FROGLIGHT_SLAB = register("verdant_froglight_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.copy(VERDANT_FROGLIGHT).sound(SoundType.FROGLIGHT).lightLevel((blockstate) -> 15), false, 0, 0, null));
    public static final RegistryObject<SlabBlock> PEARLESCENT_FROGLIGHT_SLAB = register("pearlescent_froglight_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.copy(PEARLESCENT_FROGLIGHT).sound(SoundType.FROGLIGHT).lightLevel((blockstate) -> 15), false, 0, 0, null));
