...
public class ashBlocks {
    ...
    public static final RegistryObject<SlabBlock> ASH_SLAB = register("ash_slab",
            () -> new slabBlock(BlockBehaviour.Properties.copy(ASH_BLOCK.get()).sound(SoundType.WOOD),false, 0,0, null),8000);
    public static final RegistryObject<StairBlock> ASH_STAIR = register("ash_stair",
            ()-> new stairBlock(ASH_BLOCK.get(), BlockBehaviour.Properties.copy(OAK_STAIRS).sound(SoundType.WOOD), false, 0,0, null),12000);
    ...
    public static final RegistryObject<WallBlock> ASH_WALL = register("ash_wall",
            ()-> new wallBlock(BlockBehaviour.Properties.copy(ASH_BLOCK.get()).sound(SoundType.WOOD), false, 0,0, null),10000);
    public static final RegistryObject<FenceBlock> ASH_FENCE = register("ash_fence",
            () -> new fenceBlock(BlockBehaviour.Properties.copy(ASH_BLOCK.get()).sound(SoundType.WOOD), false, 0,0, null), 5000);
    public static final RegistryObject<FenceGateBlock> ASH_FENCE_GATE = register("ash_fence_gate",
            () -> new fenceGateBlock(BlockBehaviour.Properties.copy(ASH_BLOCK.get()).sound(SoundType.WOOD), false, 0,0, null), 5000);
