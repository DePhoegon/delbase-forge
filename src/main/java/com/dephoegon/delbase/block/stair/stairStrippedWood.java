...
public class stairStrippedWood {
    ...
    public static final RegistryObject<StairBlock> STRIPPED_MANGROVE_WOOD_STAIR = register("stripped_mangrove_wood_stair",
            () -> new woodStair(MANGROVE_WOOD, true, null), 5001);
