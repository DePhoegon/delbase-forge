...
public class stairLeaves {
    ...
    public static final RegistryObject<StairBlock> MANGROVE_LEAF_STAIR = register("mangrove_leaf_stair",
            ()-> new stairBlock(MANGROVE_STAIRS::defaultBlockState, BlockBehaviour.Properties.copy(MANGROVE_LEAVES).sound(SoundType.GRASS).mapColor(MapColor.PLANT).noOcclusion().isSuffocating(genBlock::never).isViewBlocking(genBlock::never).noOcclusion()
                    ,"","","", true, null));
    public static final RegistryObject<StairBlock> CHERRY_LEAF_STAIR = register("cherry_leaf_stair",
            ()-> new stairBlock(CHERRY_STAIRS::defaultBlockState, BlockBehaviour.Properties.copy(CHERRY_LEAVES).sound(SoundType.CHERRY_LEAVES).noOcclusion().isSuffocating(genBlock::never).isViewBlocking(genBlock::never).noOcclusion()
                    ,"","","", true, null));
    public static final RegistryObject<StairBlock> AZALEA_LEAF_STAIR = register("azalea_leaf_stair",
            ()-> new stairBlock(OAK_STAIRS::defaultBlockState, BlockBehaviour.Properties.copy(AZALEA_LEAVES).sound(SoundType.AZALEA_LEAVES).mapColor(MapColor.PLANT).noOcclusion().isSuffocating(genBlock::never).isViewBlocking(genBlock::never).noOcclusion()
                    ,"","","", true, null));
    public static final RegistryObject<StairBlock> FLOWERING_AZALEA_LEAF_STAIR = register("flowering_azalea_leaf_stair",
            ()-> new stairBlock(OAK_STAIRS::defaultBlockState, BlockBehaviour.Properties.copy(FLOWERING_AZALEA_LEAVES).sound(SoundType.FLOWERING_AZALEA).mapColor(MapColor.PLANT).noOcclusion().isSuffocating(genBlock::never).isViewBlocking(genBlock::never).noOcclusion()
                    ,"","","", true, null));
